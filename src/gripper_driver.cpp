...
dh::DH_Driver::DH_Driver(): velocity_(0),position_1(0),target_reached_1(false)
{
...
void dh::DH_Driver::getMotorPosition(const int &motor_id)
{
...
void dh::DH_Driver::getFeedback(const int &motor_id)
{
